...
| 9. Production | Admin authentication, security, domain, GitHub, SmarterASP release and monitoring | Operational for the public plushies MVP at application release `6d96fad`; all 20 migrations, protected recurring catalogue automation, the owner account, 19-product approved catalogue, search indexing, consented analytics, pilot scorecard, collection-candidate matching, conversion preflight and privacy-minimised performance reporting are live. Managed TLS, redirects, HSTS, health, affiliate redirects and all neighbouring-site checks pass; production S2S remains fail-closed and is still a conversion-operations follow-on. |
