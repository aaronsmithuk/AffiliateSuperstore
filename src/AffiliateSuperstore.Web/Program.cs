...
builder.Services.AddTransient<CatalogueGovernanceReportService>();
builder.Services.AddTransient<AutonomousCollectionPublicationService>();
builder.Services.AddTransient<AutonomousCollectionGrowthService>();
