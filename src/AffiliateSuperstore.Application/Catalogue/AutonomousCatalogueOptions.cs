...
public sealed class AutonomousCatalogueOptions
{
    ...
    public int DefaultMaximumCandidatesPerRun { get; set; } = 6;
    ...
    public bool AutomaticCollectionGrowthEnabled { get; set; } = true;
    public int CollectionGrowthEveryHours { get; set; } = 6;
    public int MaximumAutomaticCollectionAssignmentsPerRun { get; set; } = 12;
    public bool AutomaticCollectionPublishingEnabled { get; set; } = true;
    public int MinimumAutomaticCollectionProducts { get; set; } = 12;
